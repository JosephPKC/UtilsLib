...
namespace Cache.Test
{
    public class StringCacheTest
    {
        ...
        public void Clear_LoadedCache_EmptyCache()
        {
            string key = "key";
            string value = "value";
            ICache<string, string> cache = TestStringCacheFactory.CreateLoadedCache(key, value);
        ...
        public void Put_ValidKey_ValNotFound_ReturnTrueAddVal()
        {
            string key = "key";
            string value = "value";
            ICache<string, string> cache = TestStringCacheFactory.CreateEmptyCache<string>();
