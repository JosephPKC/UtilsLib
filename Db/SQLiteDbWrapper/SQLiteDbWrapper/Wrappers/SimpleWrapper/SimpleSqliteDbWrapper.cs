...
namespace SqliteDbWrapper.Wrappers.SimpleWrapper
{
	...
	internal sealed class SimpleSqliteDbWrapper<TBaseDbModel>(IDbConnection pDbConnection, ICache<string, ICollection<TBaseDbModel>> pCache, ILogger pLogger) : ISqliteDbWrapper<TBaseDbModel>
	{
