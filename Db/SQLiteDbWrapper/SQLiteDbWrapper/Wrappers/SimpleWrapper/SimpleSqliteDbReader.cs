...
namespace SqliteDbWrapper.Wrappers.SimpleWrapper
{
	...
	/// </summary>
	internal sealed class SimpleSqliteDbReader<TBaseDbModel>(IDbConnection pSqlite, ICache<string, ICollection<TBaseDbModel>> pCache, ILogger pLog) : BaseSqliteDbReader<TBaseDbModel>(pSqlite, pCache, pLog), ISqliteDbReader<TBaseDbModel>
	{
