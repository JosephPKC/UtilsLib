...
namespace SqliteDbWrapper.Testing
{
    ...
    {
        public static ISqliteDbWrapper<TModel> GetSimpleWrapper<TModel>(IDbConnection pDbConnection, ICache<string, ICollection<TModel>> pCache, ILogger pLogger)
        {
            return new SimpleSqliteDbWrapper<TModel>(pDbConnection, pCache, pLogger);
        }

        public static ISqliteDbWrapper<TModel> GetLoggedWrapper<TModel>(IDbConnection pDbConnection, ICache<string, ICollection<TModel>> pCache, ILogger pLogger)
        {
